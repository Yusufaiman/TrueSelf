...
import { buildTraitPattern, detectPattern, TRAIT_DESCRIPTIONS } from './lib/personality-engine/trait-pattern-engine';
...
const patterns = [result1.pattern, result2.pattern, result3.pattern, result4.pattern];
const uniquePatterns = new Set(patterns);
console.log(`✓ Generated ${uniquePatterns.size} unique patterns from 4 test cases`);
