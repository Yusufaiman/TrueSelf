...
export type PersonalityFamily = 'thinkers' | 'feelers' | 'doers' | 'adapters' | 'strugglers';
...
export const PERSONALITY_TYPES: Record<string, PersonalityType> = {
  ...
  'strategic-architect': {
    ...
    strengths: ['Strategic thinking', 'System design', 'Long-term planning', 'Logical consistency', 'Foresight'],
    blindSpots: ['Adaptability', 'Emotional nuance', 'Spontaneity', 'Quick pivoting'],
    actions: [
  ...
  'silent-analyst': {
    ...
    strengths: ['Deep analysis', 'Pattern recognition', 'Calm observation', 'Independent thinking', 'Precision'],
  ...
  'precision-mind': {
    ...
    tagline: 'Accuracy, clarity, and attention to detail define everything you do.',
    shortDesc:
    ...
    strengths: ['Attention to detail', 'Quality control', 'Clarity', 'Reliability', 'Standardization'],
  ...
  'pattern-decoder': {
    ...
    strengths: ['Pattern recognition', 'Creative synthesis', 'Intuitive insight', 'Prediction', 'Connection-making'],
    blindSpots: ['Communication', 'Logical articulation', 'Detail focus', 'Following through'],
    actions: [
  ...
  'systems-builder': {
    ...
    strengths: ['System design', 'Process optimization', 'Logical organization', 'Scalability', 'Efficiency'],
  ...
  'rational-commander': {
    ...
    tagline: 'You see clearly, decide decisively, and move forward with purpose.',
    shortDesc:
    ...
    strengths: ['Decision-making', 'Clarity', 'Leadership', 'Action-orientation', 'Conviction'],
    blindSpots: ['Consideration', 'Listening', 'Emotional intelligence', 'Patience'],
    actions: [
  ...
  'cold-visionary': {
    ...
    strengths: ['Vision', 'Foresight', 'Logical prediction', 'Innovation', 'Long-term thinking'],
    blindSpots: ['Emotional connection', 'Present-moment focus', 'Human needs', 'Relationship building'],
    actions: [
    ...
    closingLine:
      'Your vision shapes the future. Help others see what you see.',
  },
  ...
  'calculated-planner': {
    ...
    strengths: ['Planning', 'Anticipation', 'Risk reduction', 'Goal-setting', 'Problem prevention'],
    blindSpots: ['Spontaneity', 'Flexibility', 'Living in the moment', 'Intuitive leaps'],
    actions: [
  ...
  'emotional-navigator': {
    ...
    strengths: ['Emotional intelligence', 'Empathy', 'Active listening', 'Understanding', 'Emotional guidance'],
    blindSpots: ['Logic', 'Detachment', 'Boundary-setting', 'Facing hard truths'],
    actions: [
  ...
  'deep-feeler': {
    ...
    strengths: ['Intensity', 'Emotional depth', 'Meaningful connection', 'Artistry', 'Authenticity'],
    blindSpots: ['Resilience', 'Coping with shallow interaction', 'Emotional regulation', 'Practical thinking'],
    actions: [
  ...
  'empathic-observer': {
    ...
    strengths: ['Empathy', 'observation', 'Understanding', 'Presence', 'Sensitivity'],
    blindSpots: ['Speaking up', 'Self-advocacy', 'Large groups', 'Assertiveness'],
    actions: [
  ...
  'inner-storm': {
    ...
    strengths: ['Authenticity', 'Intensity', 'Creative passion', 'Emotional honesty', 'Aliveness'],
    blindSpots: ['Regulation', 'Considering others', 'Long-term stability', 'Patience'],
    actions: [
  ...
  'gentle-anchor': {
    ...
    strengths: ['Stability', 'Emotional grounding', 'Presence', 'Calmness', 'Reliability'],
    blindSpots: ['Emotional expression', 'Sharing feelings', 'Vulnerability', 'Receiving support'],
    actions: [
  ...
  'sensitive-visionary': {
    ...
    strengths: ['Vision with purpose', 'Emotional authenticity', 'Meaning-making', 'Inspiration', 'Passion'],
    blindSpots: ['Pragmatism', 'Accepting current reality', 'Accepting imperfection', 'Compromise'],
    actions: [
  ...
  'heart-led-soul': {
    ...
    strengths: ['Authenticity', 'Heart-centered values', 'Emotional honesty', 'Intuitive wisdom', 'Passion for life'],
    blindSpots: ['Logic', 'Long-term thinking', 'Practical consequences', 'Others\' perspectives'],
    actions: [
  ...
  'emotional-alchemist': {
    ...
    strengths: ['Emotional processing', 'Wisdom through experience', 'Helping transformation', 'Authenticity', 'Growth mindset'],
    blindSpots: ['Simplicity', 'Being "normal"', 'Lightness', 'Accepting limits'],
    actions: [
  ...
  'relentless-executor': {
    ...
    strengths: ['Follow-through', 'Goal achievement', 'Reliability', 'Persistence', 'Responsibility'],
    blindSpots: ['Rest', 'Knowing when to quit', 'Flexibility', 'Enjoyment of process'],
    actions: [
  ...
  'action-taker': {
    ...
    tagline: 'You move toward what matters without waiting for perfect conditions.',
    shortDesc:
    ...
    strengths: ['Initiative', 'Momentum', 'Learning by doing', 'Resilience', 'Courage'],
  ...
  'fearless-mover': {
    ...
    strengths: ['Risk-taking', 'Courage', 'Resilience', 'Adaptability', 'Expansiveness'],
    blindSpots: ['Caution', 'Preserving resources', 'Considering consequences', 'Patience'],
    actions: [
  ...
  'momentum-builder': {
    ...
    strengths: ['Building momentum', 'Inspiring others', 'Energy management', 'Leadership', 'Keep forward movement'],
    blindSpots: ['Patience', 'Introspection', 'Consolidating gains', 'Noticing who gets left behind'],
    actions: [
  ...
  'risk-runner': {
    ...
    strengths: ['Risk management', 'Decision-making under pressure', 'Adventure', 'Adaptability', 'Crisis management'],
    blindSpots: ['Settling down', 'Building stability', 'Deep relationships', 'Long-term contentment'],
    actions: [
  ...
  'fast-decider': {
    ...
    strengths: ['Fast decision-making', 'Confidence', 'Action-orientation', 'Leadership', 'Momentum'],
    ...
    closingLine:
      'Your decisiveness creates movement. Use it wisely.',
  },
  ...
  'hustle-driver': {
    ...
    tagline: 'You push hard toward your goals and inspire others through effort.',
    shortDesc:
    ...
    strengths: ['Effort', 'Persistence', 'Work ethic', 'Resilience', 'Inspiration'],
  ...
  'bold-initiator': {
    ...
    strengths: ['Initiation', 'Boldness', 'Visionary thinking', 'Attracting others', 'Novelty'],
  ...
  'adaptive-chameleon': {
    ...
    strengths: ['Adaptability', 'Social awareness', 'Flexibility', 'Comfort in most contexts', 'Navigation'],
    blindSpots: ['Authenticity', 'Taking a stand', 'Consistency', 'Deep identity'],
    actions: [
  ...
  'social-shapeshifter': {
    ...
    strengths: ['Social fluidity', 'Context awareness', 'Connection-building', 'Charm', 'Bridge-building'],
    blindSpots: ['Depth', 'Loyalty to one group', 'Consistency', 'Taking a stand'],
    actions: [
  ...
  'balanced-mind': {
    ...
    strengths: ['Balance', 'Stability', 'Understanding perspectives', 'Moderation', 'Equilibrium'],
  ...
  'flow-seeker': {
    ...
    strengths: ['Flow states', 'Ease', 'Intuitive navigation', 'Alignment', 'Grace'],
    blindSpots: ['Pushing through difficulty', 'Discipline', 'Taking hard stands', 'Discomfort'],
    actions: [
  ...
  'situational-thinker': {
    ...
    strengths: ['Contextual thinking', 'Nuance', 'Problem-solving', 'Flexibility', 'Integration'],
    blindSpots: ['Clear principles', 'Consistency', 'Standing firm', 'Simplicity'],
    actions: [
  ...
  'calm-adjuster': {
    ...
    strengths: ['Calm adjustment', 'Change management', 'Stability', 'Pragmatism', 'Modeling grace'],
    blindSpots: ['Emotion in transition', 'Advocating for preferences', 'Showing care', 'Resistance when needed'],
    actions: [
  ...
  'flexible-strategist': {
    ...
    strengths: ['Strategic thinking', 'Flexibility', 'Adaptive planning', 'Long-term vision', 'Real-world execution'],
    blindSpots: ['Rigorous planning', 'Following the exact plan', 'Clear predetermined paths', 'Detailed prediction'],
    actions: [
  ...
  'quiet-observer': {
    ...
    strengths: ['Observation', 'Systems understanding', 'Clear sight', 'Patience', 'Wisdom'],
    blindSpots: ['Speaking up', 'Active involvement', 'Changing things', 'Visibility'],
    actions: [
  ...
  'overthinking-prisoner': {
    ...
    strengths: ['Thoughtfulness', 'Pattern recognition', 'Awareness of complexity', 'Consideration'],
    blindSpots: ['Decisive action', 'Accepting uncertainty', 'Moving forward', 'Completion'],
    actions: [
  ...
  'self-doubter': {
    ...
    strengths: ['Humility', 'Willingness to improve', 'Capacity for growth', 'Self-awareness'],
  ...
  'hidden-potential': {
    ...
    strengths: ['Inner potential', 'Vision', 'Capability', 'Self-awareness of possibility'],
    blindSpots: ['Execution', 'Taking action', 'Releasing blockers', 'Expression'],
    actions: [
    ...
    closingLine:
      'Your potential is real. Start expressing it today.',
  },
  ...
  'inner-conflict': {
    ...
    blindSpots: ['Integration', 'Self-acceptance', 'Taking a direction', 'Wholeness'],
    actions: [
    ...
    closingLine:
      'Your conflict is real and valid. Integration is possible.',
  },
  ...
  'burnout-survivor': {
    ...
    closingLine:
      'Your recovery is your greatest achievement. Protect it.',
  },
  ...
  'lost-direction': {
    ...
    strengths: ['Openness', 'Flexibility', 'Lack of attachment to wrong path', 'Starting fresh'],
  ...
  'emotional-reactor': {
    ...
    blindSpots: ['Regulation', 'Response control', 'Considering consequences', 'Calmness'],
    actions: [
  ...
  'drained-mind': {
    ...
    closingLine:
      'Your depletion is real. Protect your energy fiercely.',
  },
];

export function getTypeDescription(typeId: string): PersonalityType | undefined {
