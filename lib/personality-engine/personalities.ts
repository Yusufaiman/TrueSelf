...
export const PERSONALITY_TYPES: Record<string, PersonalityType> = {
  ...
  "inner-storm": {
    ...
    dimensions: {
      ...
      secondary: ["emotionalControl: -1", "intuition"],
    },
    formula: createFormula({
  ...
  "overthinking-prisoner": {
    ...
    dimensions: {
      primary: ["reflection", "decisiveness: -1"],
      secondary: ["anxiety", "impulsiveness: -1"],
    },
    formula: createFormula({
      reflection: 0.35,
      decisiveness: -0.25,
  ...
  "self-doubter": {
    ...
    dimensions: {
      ...
      secondary: ["decisiveness: -1", "discipline: -1"],
    },
    formula: createFormula({
      emotionalSensitivity: 0.3,
      reflection: 0.25,
  ...
  "hidden-potential": {
    ...
    dimensions: {
      primary: ["intuition", "discipline: -1"],
  ...
  "inner-conflict": {
    ...
    dimensions: {
      primary: ["conflicted dimensions", "reflection"],
  ...
  "burnout-survivor": {
    ...
    dimensions: {
      primary: ["discipline", "emotionalControl: -1"],
      secondary: ["exhaustion", "reflection"],
    },
    formula: createFormula({
      discipline: 0.3,
      emotionalControl: -0.2,
  ...
  "lost-direction": {
    ...
    dimensions: {
      primary: ["intuition", "decisiveness: -1"],
      secondary: ["discipline: -1", "reflection"],
    },
    formula: createFormula({
      intuition: 0.3,
      decisiveness: -0.3,
  ...
  "emotional-reactor": {
    ...
    dimensions: {
      primary: ["emotionalSensitivity", "emotionalControl: -1"],
      secondary: ["impulsiveness", "reflection: -1"],
    },
    formula: createFormula({
      emotionalSensitivity: 0.35,
      emotionalControl: -0.25,
  ...
  "drained-mind": {
    ...
    dimensions: {
      primary: ["emotionalSensitivity", "socialDepth"],
      secondary: ["emotionalControl: -1", "socialEnergy: -1"],
    },
    formula: createFormula({
      emotionalSensitivity: 0.35,
      socialDepth: 0.3,
